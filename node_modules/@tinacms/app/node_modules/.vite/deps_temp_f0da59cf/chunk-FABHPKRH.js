...
function useSize(element) {
  const [size2, setSize] = React17.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
var PopperContent = React18.forwardRef(
  (props, forwardedRef) => {
    ...
    const [arrow2, setArrow] = React18.useState(null);
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React37.useRef(true);
  const isPointerInTransitRef = React37.useRef(false);
  ...
  return (0, import_jsx_runtime16.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React37.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React37.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
      ...
      onPointerInTransitChange: React37.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const wasOpenDelayedRef = React37.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: (open2) => {
  ...
  const stateAttribute = React37.useMemo(() => {
  ...
  return (0, import_jsx_runtime16.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime16.jsx)(
    TooltipContextProvider,
    {
      ...
      trigger,
      onTriggerChange: setTrigger,
      onTriggerEnter: React37.useCallback(() => {
...
var TooltipTrigger = React37.forwardRef(
  (props, forwardedRef) => {
    ...
    const handlePointerUp = React37.useCallback(() => isPointerDownRef.current = false, []);
    React37.useEffect(() => {
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime16.jsx)(PortalProvider2, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime16.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime16.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var TooltipContentHoverable = React37.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME4, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME4, props.__scopeTooltip);
  const ref = React37.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React37.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React37.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React37.useCallback(
    (event, hoverTarget) => {
...
var TooltipContentImpl = React37.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime17.jsx)(PortalProvider3, { scope: __scopeDialog, forceMount, children: React38.Children.map(children, (child) => (0, import_jsx_runtime17.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime17.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlayImpl = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return (
      ...
      (0, import_jsx_runtime17.jsx)(Combination_default, { as: Slot3, allowPinchZoom: true, shards: [context.contentRef], children: (0, import_jsx_runtime17.jsx)(
        Primitive.div,
        {
          "data-state": getState(context.open),
          ...overlayProps,
...
var DialogTitle = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime17.jsx)(Primitive.h2, { id: context.titleId, ...titleProps, ref: forwardedRef });
  }
);
...
var DialogDescription = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime17.jsx)(Primitive.p, { id: context.descriptionId, ...descriptionProps, ref: forwardedRef });
  }
);
...
export {
  ...
  Provider,
  Root33 as Root34,
  Trigger2 as Trigger3,
  Portal3,
  Content23 as Content24
};
//# sourceMappingURL=chunk-FABHPKRH.js.map
