    ...
    decode = function(input) {
      ...
      for (let index2 = basic > 0 ? basic + 1 : 0; index2 < inputLength; ) {
        ...
        for (let w6 = 1, k3 = base; ; k3 += base) {
          ...
          if (digit > floor((maxInt - i8) / w6)) {
            error("overflow");
          }
          i8 += digit * w6;
          const t18 = k3 <= bias ? tMin : k3 >= bias + tMax ? tMax : k3 - bias;
          if (digit < t18) {
            break;
          }
        ...
        if (floor(i8 / out) > maxInt - n7) {
          error("overflow");
        }
        n7 += floor(i8 / out);
        i8 %= out;
        output.splice(i8++, 0, n7);
      }
...
function se4({
  ...
  (0, import_react93.useEffect)(() => {
    ...
    return Se5([
      ...
      import("./hint.es-VIKVZSZO.js"),
      import("./lint.es2-ZDTMFJX3.js"),
      import("./info.es-UZNTDYRV.js"),
      import("./jump.es-YXD3DYEL.js"),
      import("./mode.es-6YHWZ6A7.js")
    ]).then((k3) => {
      if (!A3)
        return;
      D7.current = k3;
